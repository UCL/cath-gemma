...
class_type CathGemmaComputeProfileBuildTask, { class => "Cath::Gemma::Compute::Task::ProfileBuildTask" };
class_type CathGemmaComputeProfileScanTask,  { class => "Cath::Gemma::Compute::Task::ProfileScanTask"  };
